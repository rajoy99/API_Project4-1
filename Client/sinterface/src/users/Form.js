                ...
                <div className="user"> 
                    <div className={`signin_form ${toggle ? "d-none" : "" }`}>
                        ...
                        <div className="button"> 
                            ...
                            <p>Don't have an account? <a onClick={SignupPage} href="#">Sign up</a></p>
                        </div>
                    ...
                    <div className={`signup_form ${toggle ? "" : "d-none" }`}> 
                        <div className="image">
                            <span><img src="https://imgur.com/81X12mR.png" /></span>
                            <h3>Sign up</h3>
                            <p>Start for free! Register Yourself</p>
                        </div>
                        ...
                        <div className="button">
                            ...
                            <p>Already have an account? <a onClick={SigninPage} href="#">Sign in</a></p>
                        </div>
